...
const items = [
  ...
  },
  {
    problem: {
      ...
      desc: "Prazos perdidos, auditorias reprovadas e multas da ANVISA (RDC 330, RDC 611, RDC 509, NBR 15943).",
    },
    solution: {
      icon: (
        <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      desc: "RDC 330 (gestão de tecnologias), RDC 611 (radioproteção), RDC 509 (processamento), NBR 15943 (programa de gerenciamento). Alertas, checklists e relatórios prontos para auditoria.",
    },
  },
  {
    problem: {
